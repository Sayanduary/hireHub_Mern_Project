    ...
    <div>
      ...
      <div className="flex items-center justify-center w-screen my-5">
        <form
          ...
          className="p-8 max-w-4xl border border-gray-200 bg-white rounded-md dark:border-[#444444] dark:bg-[#121212]"
        >
            ...
            <div className="col-span-2">
              ...
              <div className="mt-2 flex gap-2">
                <Input
                  ...
                  className="h-10 rounded-md border-gray-200 focus-visible:ring-0 dark:border-[#444444] flex-1"
                />
                <Button
                  type="button"
          ...
          {loading ? (
            <Button className="w-full my-4 h-10 rounded-md bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-[#121212] dark:hover:bg-gray-200">
              {" "}
            ...
            <Button
              type="submit"
              className="w-full my-4 h-10 rounded-md bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-[#121212] dark:hover:bg-gray-200"
            >
              Post New Job
            </Button>
          )}
          {companies.length === 0 && (
            <p className="text-sm text-red-600 font-semibold text-center my-3">
