    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#121212]">
            ...
            <div className='max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-8'>
                <div className='mb-6'>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-[#E0E0E0]">Companies</h1>
                    <p className="mt-1 text-sm text-gray-600 dark:text-[#888888]">Manage your company profiles</p>
                </div>
