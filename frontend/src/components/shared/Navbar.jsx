              ...
              className={({ isActive }) =>
                ...
                ${
                  isActive
                    ...
                    : "text-gray-600 hover:text-gray-900 hover:bg-transparent dark:text-[#b0b0b0] dark:hover:text-white dark:hover:bg-[#1a1a1a]"
                }`
              }
            >
              {item.label}
        ...
        <div className="flex items-center gap-2">
          ...
          {!user ? (
            <div className="hidden md:flex items-center gap-2">
              <Link
                to="/login"
                className="px-4 py-2 text-sm font-medium rounded-md text-gray-900 hover:bg-gray-900/10 dark:text-[#b0b0b0] dark:hover:bg-[#1a1a1a]"
              >
                Sign in
              </Link>
              <Link
                to="/signup"
                className="px-4 py-2 text-sm font-medium rounded-md bg-gray-900 text-white hover:bg-gray-800 dark:bg-gray-100 dark:text-[#121212] dark:hover:bg-gray-200"
              >
                Sign up
              </Link>
            </div>
